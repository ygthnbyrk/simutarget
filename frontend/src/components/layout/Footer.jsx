  ...
  return (
    <footer style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, rgba(6, 182, 212, 0.08) 0%, rgba(139, 92, 246, 0.08) 50%, rgba(6, 182, 212, 0.05) 100%)',
        zIndex: 0
      }} />
      ...
      {/* Content */}
      <div style={{ position: 'relative', zIndex: 10, maxWidth: '1200px', margin: '0 auto', padding: '100px 24px 60px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr', gap: '60px', marginBottom: '80px' }}>
          ...
          <div>
            <Link to="/" style={{ display: 'inline-block', textDecoration: 'none', marginBottom: '24px' }}>
              <img src={logoNavbar} alt="SimuTarget.ai" style={{ height: '48px', width: 'auto' }} />
            </Link>
            <p style={{ color: 'var(--color-text-secondary)', fontSize: '15px', lineHeight: '1.8', marginBottom: '28px', maxWidth: '280px' }}>
              ...
              {[
                ...
                <a
                  ...
                  style={{
                    ...
                    color: 'var(--color-text-muted)', transition: 'all 0.3s', textDecoration: 'none'
                  }}
                  onMouseEnter={(e) => {
          ...
          {/* Product */}
          <div>
            <h4 style={{ fontWeight: '700', fontSize: '16px', marginBottom: '24px', color: 'var(--color-text-primary)' }}>
              {t('footer.product')}
            </h4>
